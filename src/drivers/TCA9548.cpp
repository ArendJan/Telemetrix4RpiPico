...
TCA9548::TCA9548(uint8_t deviceAddress, uint8_t busnum) {
...
bool TCA9548::isConnected() { return isConnected(_address); }

bool TCA9548::isConnected(uint8_t address) {
  return check_addr(_busnum, address);
}
...
uint8_t TCA9548::channelCount() { return _channels; }
...
bool TCA9548::disableAllChannels() { return setChannelMask(0x00); }

bool TCA9548::setChannelMask(uint8_t mask) {
  if ((_mask == mask) && (not _forced))
    return true;
  _mask = mask;
  return write_i2c(_busnum, _address, {_mask});
}
...
uint8_t TCA9548::getChannelMask() {
  if (_forced) //  read from device.
  {
    ...
    data.resize(1, 0);
    read_i2c(_busnum, _address, {}, 1, data);
    _mask = data[0];
...
void TCA9548::setForced(bool forced) { _forced = forced; };

bool TCA9548::getForced() { return _forced; };
...
// //  PCA9548
// //
// PCA9548::PCA9548(uint8_t deviceAddress, TwoWire *wire) :
// TCA9548(deviceAddress, wire)
// {
//   _channels = 8;
// }
...
// //  PCA9546
// //
// PCA9546::PCA9546(uint8_t deviceAddress, TwoWire *wire) :
// TCA9548(deviceAddress, wire)
// {
//   _channels = 4;
// }
...
// //  PCA9545
// //
// PCA9545::PCA9545(uint8_t deviceAddress, TwoWire *wire) :
// TCA9548(deviceAddress, wire)
// {
//   _channels = 4;
// }
...
// //  PCA9548
// //
// PCA9543::PCA9543(uint8_t deviceAddress, TwoWire *wire) :
// TCA9548(deviceAddress, wire)
// {
//   _channels = 2;
// }
